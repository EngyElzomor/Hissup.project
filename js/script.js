...
var ingredientContent= Array.from(document.querySelectorAll("#Ingredients-Facts .ingredient-content"));
var icons=Array.from(document.querySelectorAll("#Ingredients-Facts .icon"));
